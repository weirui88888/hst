<template>
  <div v-if="modelValue" class="fixed inset-0 z-50 grid place-items-center bg-black/60">
    <div
      class="w-[92vw] max-w-xl rounded-lg bg-neutral-900 p-4 shadow-lg border border-neutral-700"
    >
      ...
      <form class="space-y-3" @submit.prevent="onSubmit">
        <div>
          ...
          <input
            v-model="title"
            class="w-full px-3 py-2 rounded-md bg-neutral-100 dark:bg-neutral-800 outline-none"
            required
          />
        </div>
        <div>
        ...
        <div class="pt-2 flex justify-end gap-2">
          <button
            type="button"
            class="px-3 py-1 rounded-md border border-neutral-700 text-neutral-300 hover:border-neutral-600"
          ...
          <button
            type="submit"
            class="px-3 py-1 rounded-md bg-neutral-800 text-neutral-200 hover:bg-neutral-700 border border-neutral-700"
          >
            保存
          </button>
        </div>
