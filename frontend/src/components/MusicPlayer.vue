...
<script setup lang="ts">
  ...
  import { generateMusicPlayerCSSVariables, MUSIC_PLAYER_THEME } from '../config/musicPlayerTheme';
...
<style scoped>
  ...
  .music-player .cd-left-small {
    border-color: transparent var(--music-decoration-lines) transparent transparent;
  }

  .music-player .cd-left,
  .music-player .cd-left-small {
    border-color: transparent transparent transparent var(--music-decoration-lines);
  }
